 ...
 */
public class ThermoGraph extends ActionBarActivity {
    Toolbar toolbar;
    ViewPager pager;
    ViewPagerAdapterThermo adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter =  new ViewPagerAdapterThermo(getSupportFragmentManager(),Titles,Numboftabs);
